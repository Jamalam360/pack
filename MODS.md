...
- **[Architecture Extensions](https://modrinth.com/project/arch-ex)** - A mod
  that allows you to make more detailed builds with all kinds of new building
  blocks and shapes.
...
- **[Immersive Weathering](https://modrinth.com/project/immersive-weathering)** -
  ...
  ever.
- **[InmisAddon](https://modrinth.com/project/inmisaddon)** - Addon for the
  inmis mod which enhances the visuals
...
- **[Origins Minus](https://modrinth.com/project/origins-minus)** - Origins
  focused on simplicity, not balance.
- **[Pehkui](https://modrinth.com/project/pehkui)** - Lets you change the size
  of most entities, shrinking them smaller or growing them larger
...
- **[libIPN](https://modrinth.com/project/libipn)** - Inventory Profiles Next
  GUI/Config library
- **[megane](https://modrinth.com/project/megane)** - WTHIT plugin that shows
  more tooltip than you'll ever want.
- **[MidnightLib](https://modrinth.com/project/midnightlib)** - Common library
  with a built-in configuration system
- **[mine11lib](https://modrinth.com/project/mine11lib)** - Mineblock's Repeated
  Utilities
...
- **[Pehkui](https://modrinth.com/project/pehkui)** - Lets you change the size
  of most entities, shrinking them smaller or growing them larger
- **[Quilt Kotlin Libraries (QKL)](https://modrinth.com/project/qkl)** - Quilt's
...
- **[Adorn](https://modrinth.com/project/adorn)** - Decorate your home!
- **[Excorrelation](https://modrinth.com/project/excorrelation)** - A digital
  storage mod — a reimagining of Correlated for modern versions
...
- **[Nether Wart Blocks to Nether Warts](https://modrinth.com/project/nether-wart-block-to-nether-warts)** -
  With this mod you can craft Nether Wart Blocks back to Nether Warts
- **[Sort](https://modrinth.com/project/sort)** - a minimalistic container
  sorter
- **[Utility Belt](https://modrinth.com/project/utility-belt)** - Free your
  hotbar.
- **[Why stacks of 16?](https://modrinth.com/project/why-stacks-of-16)** - Stack
...
- **[Automobility](https://modrinth.com/project/automobility)** - Vehicle mod
  adding customizable and functional cars
- **[CC: Restitched](https://modrinth.com/project/cc-restitched)** -
...
- **[megane](https://modrinth.com/project/megane)** - WTHIT plugin that shows
  more tooltip than you'll ever want.
- **[MidnightControls](https://modrinth.com/project/midnightcontrols)** - Adds
  controller support and enhanced controls overall.
- **[MidnightLib](https://modrinth.com/project/midnightlib)** - Common library
  with a built-in configuration system
...
- **[Playlist](https://modrinth.com/project/playlist)** - Control Minecraft's
